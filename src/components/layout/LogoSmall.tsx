...
const LogoSmall = ({ width = 16 }: LogoProps): ReactElement => {
  ...
  return (
    ...
    >
      <Box component="span" mt="-5px" mr="10px">
        <StyledLogoSvg width={width} src="./logo.svg" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill={import.meta.env.VITE_ENVIRONMENT === "UAT" ? colors.red[500] : colors.accent[500]}
          width={width}
          viewBox="0 0 16 16"
        >
      ...
      <Typography
        ...
        sx={{
          ...
          textDecoration: "none",
          "&:hover": {
            color: theme.palette.text.primary + getHexOpacity(80),
          },
        }}
      >
        {projectDetails.name.toUpperCase()}
      </Typography>
      {import.meta.env.VITE_ENVIRONMENT === "UAT" && (
        ...
        >
          <Typography color={theme.palette.text.secondary} fontWeight={700} fontSize={10}>
            UAT
          </Typography>
        </Box>
      )}
...
const StyledLogoSvg = styled("img")(({ theme }) => ({
  fill: theme.palette.common.red[500],
  width: 50,
}));
