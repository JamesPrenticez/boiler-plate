...
const LogoBig = ({ size = 1 }: LogoProps): ReactElement => {
  ...
  return (
    <Box
      display="flex"
      flexDirection={`${xs ? "column-reverse" : sm ? "column-reverse" : "row"}`}
      alignItems="center"
    ...
    >
      ...
      {import.meta.env.VITE_ENVIRONMENT === "UAT" && (
        ...
        >
          <Typography color={theme.palette.text.white} fontWeight={700} fontSize={25}>
            UAT
          </Typography>
        </Box>
      )}
